...
import com.buildltd.buildapp.quinzby.helpers.PrefManager;
...
public class IntroductionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* prefManager = new PrefManager(mContext);
        ...
        layouts = new int[]{R.layout.slide_layout1,R.layout.slide_layout2,R.layout.slide_layout3,R.layout.slide_layout4};
